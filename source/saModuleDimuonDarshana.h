#ifndef SAMODULEDIMUONDARSHANA_H_
#define SAMODULEDIMUONDARSHANA_H_
...
class saModuleDimuonDarshana : public saModuleBase{

public:
  saModuleDimuonDarshana(const std::string &name = "DimuonDarshana");
  virtual
...
#endif /* saModuleDimuonDarshana_H_ */
